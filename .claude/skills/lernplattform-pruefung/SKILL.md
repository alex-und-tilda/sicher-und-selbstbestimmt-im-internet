...
```bash
node .claude/skills/lernplattform-pruefung/pruefen.cjs main
```
...
Vorschau starten mit `preview_start` und dem Namen aus `.claude/launch.json` (Claude: Port 8001, §16a.8). Dann mit dem eingebauten Browser:

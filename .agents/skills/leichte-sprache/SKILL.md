...
node .Codex/skills/leichte-sprache/leicht-pruefen.cjs --thema datenschutz
# alle Themen
node .Codex/skills/leichte-sprache/leicht-pruefen.cjs --alle
# einzelner Text
node .Codex/skills/leichte-sprache/leicht-pruefen.cjs --text "Ich klicke nicht auf Links."
# mehrere Zeilen (z. B. aus alltag-de.js oder ketten-de.js herausgesuchte Leicht-Texte)
printf '%s\n' "Satz eins." "Satz zwei." | node .Codex/skills/leichte-sprache/leicht-pruefen.cjs
```
